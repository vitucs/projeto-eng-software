...
<body>
    ...
    <main class="principal">
        <div class="top-background">
            ...
            switch ($valor) {
                case "1":
                    ?> <script>window.location.href='contratar.php';</script> <?php
                    break;
                case "2":
                    ?> <script>window.location.href='buscar.php';</script> <?php
                    break;
                case "3":
                    ?> <script>window.location.href='demitir.php';</script> <?php
                    break;
            }
            ?>
        </div>
